...
public class V_affichChaufSurperflus extends JFrame {
	 ...
	 * Create the frame.
	 */
	public V_affichChaufSurperflus(Balade balade) {
		...
		Object[][] data =new Object[balade.chauffeurSuperflus().size()][3];
		int j=0;
		for(Voiture voiture :balade.chauffeurSuperflus()) {
