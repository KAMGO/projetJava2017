...
public class test extends JFrame {
	...
	JButton btnAjoutBalade = new JButton("Ajouter balade");

	/**
	 * Create the frame.
	 */
	public test(Membre membre) {
		...
		btnRetour.setBounds(58, 291, 89, 23);
		...
		btnAjoutBalade.setBounds(293, 291, 134, 23);
		contentPane.add(btnAjoutBalade);
		btnAjoutBalade.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
